...
if(isset($_POST['submit'])!=""){
    ...
    move_uploaded_file($temp,"../files/recep_merca/".$name);
  
  $query=$conexion->query("INSERT INTO recep_merca (name,date) VALUES ('$name','$date')");
  if($query){
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="tbl">
                    ...
                    <tbody>
                    <?php 
					$query=mysqli_query($conexion,"SELECT * from recep_merca ORDER BY id DESC")or die(mysqli_error($conexion));
					...
					<tr>
                                ...
                                if (empty($existe) && $id_user != 1) {
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        ...
                                        <div class="modal-body">
                                            <embed src="../files/recep_merca/<?php echo $name;?>#toolbar=0" type="application/pdf" width="100%" height="600px" />
                                        </div>
                                        </div>
                                    </div>
                                    </div>    
                        ...
                        <?php
                                ...
                                if (empty($existe) && $id_user != 1) {
                                    ...
                                    ?>
                                    <a class="btn btn-danger" href="delete_recep_merca.php?del=<?php echo $row['id']?>"><i class="fa fa-trash"></i></a>
                                    <?php ;} ?>
                                </td>
					        </tr>
						<?php } ?>
