    ...
    <div class="card-body">
        <form action="" method="post" autocomplete="off" id="formulario">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="cedula">Cargo o Gerencia</label>
                        <input type="text" class="form-control" placeholder="Ingrese el cargo o gerencia" name="cedula" id="cedula">
                    </div>
            ...
            if ($result > 0) {
                while ($data = mysqli_fetch_assoc($query)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="rol.php?id=<?php echo $data['idusuario']; ?>" class="btn btn-warning"><i class='fas fa-key'></i>   Permisos</a>
                            <a href="#" onclick="editarUsuario(<?php echo $data['idusuario']; ?>)" class="btn btn-success"><i class='fas fa-edit'></i>  Editar</a>
